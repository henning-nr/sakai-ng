...
export class ProductService {
    ...
    createProduct(product: Product) : any { return this.db.list<Product>(this.basePath).push(product); };
...
export class ProductServiceDatabase {
    private basePath = 'products'
    ...
    updateProduct(key : string, val : any) : Promise<void> {
        return this.db.object<Product>(`${this.basePath}/${key}`).update(val);
    }
